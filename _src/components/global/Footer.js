...
export default class Footer {
  ...
  render() {
    ...
    <footer class="main-footer grid">
      <div class="grid__subgrid main-footer__copy-plus-container">
        <span
          class="main-footer__copy main-footer__text grid__body-start grid__space-start--gt1250 grid__body-left--gt1500"
          >&copy; 2024 Abed&nbsp;Islam</span
        >
        <div class="main-footer__text grid__body-start--gt1250 grid__mid-body">
          <span
            class="main-footer__built"
          ...
          <nav class="main-footer__links"><a href="/cookie-policy/">Cookie Policy</a></nav>
        </div>
      </div>
      <nav
